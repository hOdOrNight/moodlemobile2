 ...
 */
.factory('$mmaModFolder', function($mmSite, $mmCourse, $q, $mmSitesManager) {
    var self = {};
     ...
     */
    self.invalidateFolderData = function(courseId) {
        return $mmSite.invalidateWsCacheForKey(getFolderCacheKey(courseId));
    };
